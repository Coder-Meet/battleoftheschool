> Historical presenter notes. Use [the current cheatsheet](../../CHEATSHEET.md) for release claims.
...
| Minimum radius | Seed-radius default 0.7 mm; confirmed minimum origin diameter 2 mm |
